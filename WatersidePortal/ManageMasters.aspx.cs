    ...
    public partial class ManageMasters : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                int basePrice = 54500;
                string cmdString = "Select * From [dbo].[MasterBids] Where ProjectID=@pID";
