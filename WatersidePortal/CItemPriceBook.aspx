                        ...
                        <asp:Panel ID="Panel_Items" runat="server" CssClass="panel panel-default">
                            ...
                            <div class="panel-body panel panel-default">
                                ...
                                <div class="panel-body panel panel-default">
                                    ...
                                    <%-- Mark As Unfinished --%>
                                    <asp:CheckBox ID="unfinished" runat="server" EnableTheming="True" />
                                    <asp:Label ID="RememberMeLabel" runat="server" CssClass="inline checked" ForeColor="#2196f3" Font-Size="Large">&nbsp;Mark Unfinished</asp:Label>
                                </div>
