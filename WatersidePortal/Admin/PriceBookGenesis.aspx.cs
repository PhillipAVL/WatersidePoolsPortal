...
{
    public partial class PriceBookGenesis : System.Web.UI.Page
    {
        ...
        {
            string cmdString = "INSERT INTO PriceBookGenesis ([Category],[Subcategory],[Item],[Description],[Unit],[CustomerPrice],[COGS],[ImageString]) VALUES (@Category, @Subcategory, @Item, @Description, @Unit, @CustomerPrice, @COGS, @ImageString)";
