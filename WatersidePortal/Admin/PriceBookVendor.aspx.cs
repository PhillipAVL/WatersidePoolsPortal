...
{
    public partial class PriceBookVendor : System.Web.UI.Page
    {
        ...
        {
            string cmdString = "INSERT INTO PriceBookVendors ([Category],[Subcategory],[Item],[Description],[Unit],[CustomerPrice],[COGS],[ImageString],[ManufacturerID]) VALUES (@Category, @Subcategory, @Item, @Description, @Unit, @CustomerPrice, @COGS, @ImageString, @ManufacturerID)";
            ...
            using (SqlConnection conn = new SqlConnection(connString))
            {
                using (SqlCommand comm = new SqlCommand())
                {
                    ...
                    comm.Parameters.AddWithValue("@ManufacturerID", TextBox_ManufacturerID.Text);
                    TextBox_ManufacturerID.Text = "";
