<%@Page Title="Pricebook Vendor" Language="C#" MasterPageFile="~/Shared/MasterPages/SiteLayoutAdmin.Master" AutoEventWireup="true" CodeBehind="PriceBookVendor.aspx.cs" Inherits="WatersidePortal.Admin.PriceBookVendor" %>
                ...
                <asp:GridView ID="GridView_Items" runat="server" CssClass ="table table-striped table-bordered table-hover" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="ItemID" DataSourceID="Items" AutoGenerateEditButton="True" OnRowEditing="GridView_Items_RowEditing">
                    <Columns>
                        ...
                        <asp:BoundField DataField="ImageString" HeaderText="ImageString" SortExpression="ImageString" ControlStyle-CssClass="form-control"/>
                            ...
                            <br />
                            <asp:SqlDataSource ID="Items" runat="server" ConnectionString="<%$ ConnectionStrings:WatersidePortal_dbConnectionString %>" SelectCommand="SELECT * FROM [PriceBookVendors]" DeleteCommand="DELETE FROM [PriceBookVendors] WHERE [ItemID] = @ItemID" InsertCommand="INSERT INTO [PriceBookVendors] ([Category], [Subcategory], [Item], [Description], [Unit], [CustomerPrice], [COGS], [ImageString]) VALUES (@Category, @Subcategory, @Item, @Description, @Unit, @CustomerPrice, @COGS, @ImageString)" UpdateCommand="UPDATE [PriceBookVendors] SET [Category] = @Category, [Subcategory] = @Subcategory, [Item] = @Item, [Description] = @Description, [Unit] = @Unit, [CustomerPrice] = @CustomerPrice, [COGS] = @COGS, [ImageString] = @ImageString WHERE [ItemID] = @ItemID" >
<DeleteParameters>
...
<UpdateParameters>
    ...
    <asp:Parameter Name="ItemID" Type="Int32" />
                        ...
                        <div class="tab-pane fade" id="Add">
                            ...
                            <br />
                            Manufacturer ID: <asp:TextBox ID="TextBox_ManufacturerID" runat="server" CssClass="form-control control-medium"></asp:TextBox>
                            <br />
