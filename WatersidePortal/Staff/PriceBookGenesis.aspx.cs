    ...
    public partial class PriceBookGenesis : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                ...
                dt.Rows.Add("9999999", "1","Standard Genesis Pool", "32750.00", "per", "32750.00" );
                this.BindGrid();
        ...
        protected void GridView_Estimate_Databound(object sender, EventArgs e)
        {
            ...
            if (GridView_Estimates.Rows.Count != 0)
            {
                ...
                dt2.Rows.Add("", "", "", "", "Total: ", total2.ToString("0.00"));
            GridView_Estimates.DataBind();
        ...
        protected void GridView_Categories_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (subcat == "&nbsp;")
            {
                Items.SelectCommand = "SELECT TOP (1000000) [ItemID], [Item], [Description], [CustomerPrice], [Unit] FROM [PB_Genesis] WHERE [Category] = '" + GridView_Categories.SelectedRow.Cells[1].Text + "' AND [Subcategory] is null Order by [Category]";
            }
            else
            {
                Items.SelectCommand = "SELECT TOP (1000000) [ItemID], [Item], [Description], [CustomerPrice], [Unit] FROM [PB_Genesis] WHERE [Category] = '" + GridView_Categories.SelectedRow.Cells[1].Text + "' AND [Subcategory] = '" + GridView_Categories.SelectedRow.Cells[2].Text + "' Order by [Category]";
            }
            ...
            protected void FinalizeEstimateButton_Click(object sender, EventArgs e)
        {
                ...
                if (row.Cells[0].Text.Length != 0 && row.Cells[0].Text != "&nbsp;")
                {
                    ...
                    using (SqlConnection conn = new SqlConnection(connString))
                    {
                        using (SqlCommand comm = new SqlCommand())
                        {
                            ...
                            comm.Parameters.AddWithValue("@PoolType", "Genesis");
            ...
            using (FileStream stream = File.Open(Server.MapPath("/Forms/genesis_template_part1.pdf"), FileMode.Open))
            {
