<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/MasterPages/SiteLayout.Master" AutoEventWireup="true" CodeBehind="Staff/PriceBookGenesis.aspx.cs" Inherits="WatersidePortal.Staff.PriceBookGenesis" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentBody" runat="server">
    ...
    <br />
    <asp:SqlDataSource ID="Categories" runat="server" ConnectionString="<%$ ConnectionStrings:WatersidePortal_dbConnectionString %>" SelectCommand="SELECT DISTINCT [Category], [Subcategory] FROM [PB_Genesis] ORDER BY [Category]"></asp:SqlDataSource>
...
black"><o:p></o:p></span></p>
                                ...
                                <br />
                                EstimateID:
                                <asp:DropDownList ID="DropDownList_Estimates" runat="server" DataSourceID="SqlDataSource1" DataTextField="EstimateID" DataValueField="EstimateID" AutoPostBack="True" OnSelectedIndexChanged="IndexChanged"></asp:DropDownList>


                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:WatersidePortal_dbConnectionString %>" SelectCommand="SELECT DISTINCT [EstimateID] FROM [Estimates] WHERE (([CustomerID] = @CustomerID) AND ([CreatedBy] = @CreatedBy) AND PoolType = 'Genesis')">
                                    <SelectParameters>
