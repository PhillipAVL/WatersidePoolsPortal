        ...
        <section class="wrapper site-min-height">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="title">EZ-Flow Pool Bid Proposal
                ...
                <div class="panel-body">
                    <ul class="nav nav-tabs">
                        ...
                        <li>
                            <a href="#Estimate" data-toggle="tab">Generate Pool Bid Proposal
                                    </a>
                        </li>
                        <li>
                            <a href="#Recall" data-toggle="tab">Recall Pool Bid Proposal
                                    </a>
                        </li>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade in active" id="Select">
                            ...
                            <br />
                            <h4>Select the items for the Pool Bid Proposal. Results appear on the Pool Bid Proposal tab.
                        ...
                        <div class="tab-pane fade" id="Estimate">
                            ...
                            <h4>Homeowner Responsibilities</h4>
                            <table class="auto-style1">
                                <tr>
                                    <td>
                                        <asp:CheckBox ID="CheckBox1" runat="server" Text=" Landscaping, Irrigation, Sod and /or Hay &amp; Seed " />
                                        <br />
                                    ...
                                    <td>
                                        <asp:CheckBox ID="CheckBox6" runat="server" Text=" Additional Fill " />
                                        <br />
                            ...
                            <br />
                            <h4>Permit Downloads below</h4>
                            <p>
                                <span style="font-family: &quot; helveticaneue&quot; ,serif; color: black">Flagler County, Flagler Beach, St. Augustine Beach, St. Johns County, Volusia County, Ormond Beach, Palm Coast, Bunnell, City of St. Augustine</span><span style="color: black"><o:p></o:p></span>
                            </p>
                        </div>
                        <div class="tab-pane fade" id="Recall">
                            <h4>Recall Pool Bid Proposal
                                    </h4>
                            ...
                            <br />
                            Customer:
                            <asp:DropDownList ID="DropDownList_Customer2" runat="server" DataSourceID="Customers" DataTextField="FullName" DataValueField="CustomerID" OnSelectedIndexChanged="GetEstimatesForCustomer" AutoPostBack="True"></asp:DropDownList>
                            <br />

                            <%-- Select Estimate Id --%>
                            EstimateID:
                           <%--DataSourceID="SqlDataSource1"--%> 
                            <asp:DropDownList ID="DropDownList_Estimates" runat="server" DataTextField="EstimateID" DataValueField="EstimateID" OnSelectedIndexChanged="IndexChanged"></asp:DropDownList>
