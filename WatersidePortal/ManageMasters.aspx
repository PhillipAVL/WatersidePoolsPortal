<%@ Page MaintainScrollPositionOnPostback="true" Title="Manage Master Bids" Language="C#" MasterPageFile="~/Shared/MasterPages/SiteLayoutAdmin.Master" AutoEventWireup="true" CodeBehind="ManageMasters.aspx.cs" Inherits="WatersidePortal.ManageMasters" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentBody" runat="server">
                            ...
                            <asp:Panel ID="Panel_Items" runat="server" CssClass="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <ul class="nav nav-tabs">
                                        <li id="SelectTab">
                                            <a href="#Select" data-toggle="tab" onclick="tab('Select');">
                                                Select Specs
                                            </a>
                                        </li>
                                        <li id="ShoppingTab">
                                            <a href="#Shopping" data-toggle="tab" onclick="tab('Shopping');">
                                                Shopping Cart
                                            </a>
                                        </li>
                                    </ul>
                                            ...
                                            <div>
                                                <div style="width:50%; float: left">
                                                    <p>
                                                        ...
                                                        <asp:TextBox runat="server" ID="Project_Name_Box" Width="50%" />
                                                    </p>
                                                    <p>
                                                        <asp:Label runat="server" Text="Description:" ID="Project_Desc" Font-Size="Large" />
                                                        <asp:TextBox runat="server" ID="Description_Box" Width="50%" />
                                                    </p>
                                                </div>
    ...
    <script type="text/javascript">
        ...
        function tab(which) {
            if (window.location.href.split('?').length > 1 && window.location.href.split('?')[1].split('&').length > 0) {
                window.location.href = "ManageMasters?" + window.location.href.split('?')[1].split('&')[0] + "&" + which;
            }
        }
    </script>
</asp:Content>
