<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/MasterPages/SiteLayout.Master" AutoEventWireup="true" CodeBehind="Repair.aspx.cs" Inherits="WatersidePortal.Repair" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentBody" runat="server">
        ...
        <section class="wrapper site-min-height">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <br />
                    <h4 class="title">Repair Management
                    </h4>
                </div>
                <div class="panel-body">
                    <ul class="nav nav-tabs">
                        ...
                        <li id="SelectTab">
                            <a href="#Select" data-toggle="tab" onclick="tab('Select');">Select Customer
                            </a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane fade in" id="Create">
                            ...
                            <p>
                                State:<asp:TextBox ID="TextBox_State" runat="server"></asp:TextBox>
                            </p>
                            <p>
                            ...
                            <asp:CheckBox ID="wspcustomer" runat="server" OnCheckedChanged="CheckBox1_CheckedChanged" Text="Waterside Pools Customer" />
                            <p>
    ...
    <script type="text/javascript">
        if (window.location.href.split('?').length > 1) {
            ...
            window.location.href = "Repair?Create";
        }
        function tab(which) {
            if (window.location.href.split('?').length > 1) {
                window.location.href = "Repair?" + which;
            }
        }
    </script>
</asp:Content>
